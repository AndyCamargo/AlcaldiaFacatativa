	...
	<div id="content">
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
						<form action ="lista_grafica_proyecto.php" method="post">
                      <h1>Lista de Proyectos Por Graficas</h1> 		
                       <p>                
					   </p>
                     ...
                     <td><input type="submit" name="Mostrar" value="Mostrar"></td>
                      ...
                      <?php
                        ...
                        if(isset($_REQUEST['Mostrar'])){
                        	 $pro=$_POST["proyecto"];
                        	 $_SESSION["proyecto"]=$pro;
                        	
                        	echo"<img src='graficas_proyecto.php' alt='' border='0.5'>";
