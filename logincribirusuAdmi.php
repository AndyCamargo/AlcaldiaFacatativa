...
if (mysql_num_rows($res)>=1) {
    ...
    echo "<script language='JavaScript'> alert('Usuario Ya Registrado ". $cedula." .');window.location='crearusuperadmi.php'</script>";
...
$sql="INSERT  INTO `personas`(cedula,nombres,apellidos,dirreccion,barrio,celular,codigo,N_caja,fecha_ingreso,Observaciones,id_territorio,sisben,ced_castatral,id_madre,id_des,id_ries,url)
    ...
    echo "<script language='javascript'>alert('Usuario ". $nombre." ".$cedula." Registrado.');window.location='menuAdmi.php'</script>";
