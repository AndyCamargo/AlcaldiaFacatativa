...
session_start();
  if($_SESSION["cedula"]==null){
       ...
       $sql="SELECT url FROM personas WHERE cedula='$ced';";
       $resul=mysql_query($sql,$link) or die("Error en sql");
       $fil=mysql_fetch_row($resul);
       if($fil!=null){
       $url=$fil[0];
      }
...
<div id="header">
	<div id="menu">
		<ul>
			<ul>
			  <ul>
			   <li><a class="" href="menu.php">Inicio</a><a tabindex="-1" href="manualinicial.pdf" class="MenuBarItemSubmenu">Ayuda</a><a class="" href=".php"></a><a tabindex="-1" href=".php" class="MenuBarItemSubmenu"></a></li>
		  </ul>
		  </ul>
	      <li></li>
		  <li></li>
...
<div id="captions">
  <div id="nav">
    <iframe  width="820"  height="500" src="Documentos/<?php echo $ced;?>/<?php echo $url;?>"></iframe>
  </div>	
