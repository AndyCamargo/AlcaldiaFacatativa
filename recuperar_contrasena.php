		...
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
                        ...
                        <p>                
						<center>
						<h2 class="title"><span class="Estilo7">Recuperar Contrase&ntildea</span></h2>
						<table cellpadding="3" cellspacing="0">
                            ...
                            <tr>
                            	<td>
                            	<span class="Estilo6">Cedula: </span> 
                            	</td>
                            	<td></td>
                            	<td>
                               <input type = "text" name = "cedula" id = "cedula" size = 20 placeholder="Cedula" onkeypress="return solonumeros(event)">
                            	</td>
                            </tr>
                                <tr>
                                 <td>
