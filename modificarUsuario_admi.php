...
<?php 
  ...
  if($_SESSION["cedula"]==null){
	...
	$sq="SELECT codigo,nombre_de_proyecto FROM proyectos;";
	$resultado=mysql_query($sq,$link) or die("Error en sql");

	$data="SELECT id_territorio,territorio FROM terri;";
	$resulta=mysql_query($data,$link)or die("Error en sql");
...
<div id="header">
	<div id="menu">
		<ul>
			<ul>
			  <ul>
			   <li><a class="" href="menuAdmi.php">Inicio</a><a tabindex="-1" href="manualadministrador.pdf" class="MenuBarItemSubmenu">Ayuda</a><a class="" href=".php"></a><a tabindex="-1" href=".php" class="MenuBarItemSubmenu"></a></li>
		  </ul>
		  </ul>
	      <li></li>
		  <li></li>
	...
	<div id="content">
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
						<form   action="modificarUsuario_admi.php" method="post"> 
                      <h1>Modificar Usuario</h1> 		
                       ...
                       <td>Cedula:</td>
                       <td></td>
                       <td><input type="text" size="20" id="cedula" value=""name="cedula" onkeypress="return solonumeros(event)" required></td>
                       <td></td>
                      ...
                      if(isset($_REQUEST['Consultar'])){
                      	$cedu=$_POST["cedula"];
                      	$sql="SELECT a.cedula,a.nombres,a.apellidos,a.dirreccion,a.barrio,a.celular,a.N_caja,a.fecha_ingreso,a.sisben,a.ced_castatral,c.nombre_de_proyecto ,b.territorio,a.Observaciones,d.situacion,e.estado,f.estado FROM personas a ,terri b , proyectos c ,madre d,deplazado e,riesgo f WHERE a.cedula = '$cedu' AND a.id_territorio=b.id_territorio AND a.codigo=c.codigo AND a.id_madre=d.id_madre AND a.id_des=e.id_des AND a.id_ries=f.id_ries;";
                        ...
                        $fila=mysql_fetch_row($resul);
                         ...
                         $cedula=$fila[0];	
		                     ...
		                     $sisben=$fila[8];
		                     $ced_castatral=$fila[9];
		                     $nombre_de_proyecto=$fila[10];
		                     $territorio=$fila[11];
                         ...
                         $ries=$fila[15];
                      	...
                      	?>
                        <form action="logicaModiUsua_admi.php" method="post">
                        <table>
                        <tr>
                        <td>Cedula:</td>
                        <td></td>
                        <td><input type="text" size="20" id="ced" value="<?php echo "$cedula"; ?>" name="ced" readonly=”readonly” ></td>
                        </tr>
                        <td>Nombre:</td>
                        <td></td>
                        <td><input type="text" size="20" id="nombre" value="<?php echo "$nombre";?> "name="nombre"  ></td>
                        </tr>
                        <tr>
                        <td>Apellido:</td>
                        <td></td>
                        <td><input type="text" size="20" id="apellido" value="<?php echo "$apellido"; ?>"name="apellido"  ></td>
                        </tr>
                        <tr>
                        <td>Direccion:</td>
                        <td></td>
                        <td><input type="text" size="20" id="direccion" value="<?php echo "$dirreccion"; ?>"name="direccion"  ></td>
                        </tr>
                        <tr>
                        <td>Barrio:</td>
                        <td></td>
                        <td><input type="text" size="20" id="barrio" value="<?php echo "$barrio"; ?>" name="barrio"  ></td>
                        </tr>
                        <tr>
                        <td>Celular:</td>
                        <td></td>
                        <td><input type="text" size="20" id="celular" value="<?php echo "$celular";?>" onkeypress="return solonumeros(event)"  name="celular"  ></td>
                        </tr>
                        <tr>
                        <td>N Caja:</td>
                        <td></td>
                        <td><input type="text" size="20" id="caja"   value="<?php echo "$N_caja"; ?>"name="caja"  ></td>
                        </tr>
                        <tr>
                        <td>Proyecto Anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$nombre_de_proyecto"; ?> </label></td>
                        </tr>
                        <tr>
                        <td>Proyecto:</td>
                        <td></td>
                       ...
                       <td>Fecha:</td>
                       <td></td>
                       <td><div><input type="text" name="date" class="tcal" value="<?php echo "$fecha_ingreso"; ?>" /></div></td>
                       </tr>
                        <tr>
                        <td>Territorio Anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$territorio"; ?> </label></td>
                       </tr>
                       <tr>
                       <td>Territorio:</td>
                       <td></td>
                       ...
                       <?php
                       while ($ros=mysql_fetch_array($resulta))
                        {
                      ...
                      <td>Sisben:</td>
                      <td></td>
                      <td><input type="text" size="20" id="sisben" value="<?php echo "$sisben";?>"name="sisben"  ></td>
                      </tr>
                      <tr>
                      <td>Ced Catastral</td>
                      <td></td>
                      <td><input type="text" size="20" id="cata" value="<?php echo "$ced_castatral"; ?>"name="cata"  ></td>
                      </tr>
                       <tr>
                        <td>M.C Anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$madre"; ?> </label></td>
                       </tr>
                       <tr>
                     <td>Madre Cab:</td>
                     <td></td>
                     ...
                     <tr>
                        <td>Ries. Anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$ries"; ?> </label></td>
                       </tr>
                       <tr>
                     <tr>
                     <td>Riesgo:</td>
                     ...
                     <td><select id="rie" name="rie">
                      ...
                      <td>Observaciones:</td>
                      <td></td>
                      <td><textarea  name="observacion" rows="10" cols="40"><?php echo"$Observaciones"; ?></textarea></td>
                      </tr>
                      <tr>
                        <td></td>
                        <td></td>
				        <td><input type="submit" name="Guardar" value="Guardar"></td>
				        <td><a href="modificarUsuario_admi.php">Cancelar</a></td>
                        </tr>	
                        </table>
