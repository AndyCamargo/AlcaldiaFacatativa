...
if (mysql_num_rows($res)>=1) {
	...
	echo "<script language='JavaScript'> alert('Codigo ya exite ". $codigo." .');window.location='nuevo_proyecto.php'</script>";
...
mysql_close($lin);
	...
	echo "<script language='javascript'>alert('proyecto ". $nombre." ".$codigo." Registrado.');window.location='menu.php'</script>";
