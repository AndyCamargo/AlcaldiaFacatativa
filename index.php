...
<div id="logo">
    ...
    <p><span class="Estilo3"><img src="images/Escudo Facatativa.jpg" alt="" width="130" height="125"/><img src="images/Letras Logo.png" alt="" width="630" height="150"/></span><span class="Estilo3"><img src="images/todos_somos_facatativa.jpg" alt="" width="129" height="128"/></span>    
...
<div id="header">
	<div id="menu">
		<ul>
			<ul>
			  <ul>
			   <li><a class="" href="index.php">Inicio</a><a tabindex="-1" href="manualinicial.pdf" class="MenuBarItemSubmenu">Ayuda</a><a class="" href=".php">Contactenos</a><a tabindex="-1" href=".php" class="MenuBarItemSubmenu"></a></li>
		  </ul>
		  </ul>
	      <li></li>
		  <li></li>
...
?>
	...
	<div id="content">
		<div class="post">
			<h1 class="title">&nbsp;</h1>
			<center><h1 class="title"><strong>Diligenciar datos para Ingresar </strong></h1></center>
		  <div class="entry">
         ...
         <!-- start -->
					...
					<div id="slider">
                      ...
                      <form  action="verificarlogin.php" method="post">  		
                        <p>                
						<center>
						<h2 class="title"><span class="Estilo7">Inicie Sesi&oacute;n</span></h2>
						</center>
                        <blockquote>
                          <p>
                            <center>
                              <span class="Estilo6">Nombre de Usuario:   </span> 
                              <input type = "text" name = "username" id = "username" size = 20 placeholder="Nombre de usuario">
                            </center>
                          </p>
                        </blockquote>
                        <blockquote>
                          <p>
                            <center>
                              ...
                              <input type = "password" name = "password" id = "password" size = 20 placeholder="Contraseña">
                            </center>
                          </p>
                        </blockquote>
                        <br>
                        <center><input type ="submit" name = "Iniciar Sesion" value = "Iniciar Sesion"></center>
                        </p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                      </form>   
...
<div id="captions"><div id="nav"></div>	
	...
	<div id="sidebar">
		<ul>
		        <br>
				<h1>Mejoramiento de Vivienda </h1>
				<h2>&nbsp;</h2>
				<ul>
					<li> Los trabajos son desarrollados en virtud de los convenios firmados por el despacho con varias instituciones tanto oficiales como privadas,
					a fin de atender los requerimientos de este tipo dentro de los sectores vulnerables de la población.
					  <br> 
					  <br> 
					   Fundamentalmente fueron intervenidas las unidades con problemas estructurales, deficiencias en cocina,
					   baños y paredes a través de un proceso acompañado por la administración central a través del Banco Agrario.
					   El SENA brindará formación y capacitación a los beneficiarios para autoconstrucción, así mismo la administración 
					   de la ciudad aportará los recursos necesarios para finalizar las adecuaciones.
    </ul>
		</ul>
		<p>&nbsp;</p>
	    <p>&nbsp;</p>
