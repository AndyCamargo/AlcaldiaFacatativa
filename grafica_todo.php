...
$query="SELECT * FROM personas WHERE id_madre='1' AND id_ries='1' AND id_des='1';";
...
$graph->title->Set("Poblacion De Madres y Riesgo y Desplazado");
$graph->title->SetFont(FF_ARIAL,FS_BOLD,14);
 
$p1 = new PiePlot3D($data);
$p1->SetSize(0.5);
$p1->SetCenter(0.45);
$nombres=array("Otros : $to","Madres y Riesgo y Desplazado : $total"); 
