...
<?php 
  ...
  if($_SESSION["cedula"]==null){
    ...
    $sql="SELECT nombre_responsable,cedula,funcion FROM responsable;";
		...
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
                        ...
                        <form   action="logicaModiRespon.php" method="post">  		
                        <p>                
						<h1>Modificar Responsable Certificado </h1>
						<fieldset>
					<table cellpadding="3" cellspacing="0">
                        ...
                        <tr>
							<td>Cedula:</td>
							<td></td>
							<td><input type="text" size="20" id="cedula" value="<?php echo "$cedu";?>" onkeypress="return solonumeros(event)"  name="cedula"  ></td>
						</tr>
						<tr>
							<td>Funcion:</td>
							<td></td>
							<td><input type="text" id="funcion" name="funcion" value="<?php echo "$fun"; ?>" /></td>
						</tr>
						<tr>
						<td><input type="submit" name="Guardar" value="Guardar"></td>
						<td></td>
				        <td><a href="modificar_respon.php">Cancelar</a></td>
						</tr>
					</table>
					</fieldset>
                        </p>
