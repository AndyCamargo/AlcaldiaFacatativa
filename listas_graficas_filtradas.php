		...
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
						 ...
						 <form  action="listas_graficas_filtradas.php" method="post"> 
                      <h1>Lista de Filtrada Por Graficas </h1> 		
                       <p>                
					   </p>
                       <table>
                       <tr>
                       ...
                       if (isset($_POST['option1']) && $_POST['option1'] == '1' && isset($_POST['option2']) && $_POST['option2'] == '2'&& isset($_POST['option3']) && $_POST['option3'] == '3')
                       {
                        ...
                        echo"<img src='grafica_todo.php' alt='' border='0.5'>";
						...
						if (isset($_POST['option1']) && $_POST['option1'] == '1' && isset($_POST['option2']) && $_POST['option2'] == '2'){
                        	...
                        	echo"<img src='grafica_madre_despla.php' alt='' border='0.5'>";

                       }else {
					   if (isset($_POST['option1']) && $_POST['option1'] == '1' && isset($_POST['option3']) && $_POST['option3'] == '3'){
					   	echo"<img src='grafica_madre_ries.php' alt='' border='0.5'>";	
						

                       }else {
					   if (isset($_POST['option2']) && $_POST['option2'] == '2' && isset($_POST['option3']) && $_POST['option3'] == '3'){
						 
                      echo"<img src='grafica_ries_despla.php' alt='' border='0.5'>";


                       }else{
					   if (isset($_POST['option1']) && $_POST['option1'] == '1')
                       {
                       echo"<img src='grafica_madre.php' alt='' border='0.5'>";	

                       }else{
					    if (isset($_POST['option2']) && $_POST['option2'] == '2')
                       {
                       	echo"<img src='grafica_despla.php' alt='' border='0.5'>";
                       	
                       }else{
					   if (isset($_POST['option3']) && $_POST['option3'] == '3')
                       {
                       echo"<img src='grafica_riesgo.php' alt='' border='0.5'>";	
