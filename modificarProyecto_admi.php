	...
	<div id="content">
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
						 <form  action="modificarProyecto_admi.php" method="post"> 
                     ...
                     <div id="Layer1" style="width:590px; height:400px; overflow: scroll;">
                       <?php
                         ...
                         $pro=$_POST["proyecto"];
                         $query="SELECT a.nombre_de_proyecto,a.observaciones,b.id_proyecto,b.estado,a.ano FROM proyectos a ,proyec b WHERE a.codigo='$pro' AND a.id_proye=b.id_proyecto ;";                       $datos=mysql_query($query,$link) or die("Error en sql");
                     ...
                     $ano=$fila[4];
			                        ...
			                        ?>
			               <form action="logiModifirPro_admi.php" method="post">         
                           <table>
                           <tr>
                           <td>Nombre:</td>
                           <td></td>
                           <td><input type="text" id="nombres" name="nombres" value="<?php echo "$nombre"; ?>" /></td>
                           <td><input type="hidden" name="id" value="<?php echo "$pro"; ?>"></td>
                           </tr>
                           <tr>
                           <td>Año:</td>
                           <td></td>
                           <td><input type="text" size="20" id="ano" value="<?php echo "$ano"; ?> "  onkeypress="return solonumeros(event)" name="ano"></td>
                           </tr>
                           <tr>
                           <td>Estado Anterior:</td>
                           <td></td>
                           <td><label ><?php echo"$proyec"; ?></label></td>
                            </tr>
                           <tr>
                           <td>Estado:</td>
                           <td></td>
                           <td><select id="esta" name="esta">
                           ...
                           <td>Observaciones:</td>
                           <td></td>
                           <td><textarea name="obser" id="obser" rows="10" cols="40"><?php echo"$obser"; ?></textarea></td>
                           </tr>
                           <tr>
                           <td></td>
                           <td></td>
				           <td><input type="submit" name="Guardar" value="Guardar"></td>
				           <td><a href="modificarProyecto_admi.php">Cancelar</a></td>
                           </tr>
                           </table>
                           </form>
                           <?php
