		...
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
                        ...
                        <form   action="modifiUsuario_per.php" method="post"> 
                        <h1>Modificar Usuario Sistema</h1> 		
                       <p>                
                       </p>
                        <table>
                       <tr>
                      ...
                      if(isset($_REQUEST['Consultar'])){
                      	$cedu=$_POST["cedula"];
                        $sql="SELECT a.nombre,a.apellido,a.telefono,a.correo,a.puesto,a.alias,a.pass,a.cedula,b.rol,c.nombre  FROM usuario a,sg_mv_rol b,activa c WHERE a.cedula='$cedu' AND a.id_rol=b.id_rol AND a.id_activa=c.id_activa;";
                      ...
                      ?>
                      <form action="logicaModiUsua_per.php" method="post">
                     <table>
                     <tr>
                     <td>Nombre:</td>
                     <td></td>
                     <td><input type="text" size="20" id="nombre" value="<?php echo"$nombre";?>"name="nombre" required></td>
                     </tr>
                     <tr>
                     <td>Apellido:</td>
                     <td></td>
                     <td><input type="text" size="20" id="apellido"value="<?php echo "$apellido";?>" name="apellido"  required></td>
                     </tr>
                      <tr>
                     <td>Telefono:</td>
                     <td></td>
                     <td><input type="text" size="20" id="telefono"value="<?php echo "$telefono";?>" onkeypress="return solonumeros(event)" name="telefono"  ></td>
                     </tr>
                      <tr>
                     <td>Correo:</td>
                     <td></td>
                     <td><input type="text" size="20" id="correo"value="<?php echo "$Correo";?>"name="correo"  ></td>
                     </tr>
                      <tr>
                     <td>Cargo:</td>
                     <td></td>
                     <td><input type="text" size="20" id="cargo"value="<?php echo "$puesto";?>"name="cargo"  ></td>
                     </tr>
                      <tr>
                     <td>Usuario:</td>
                     <td></td>
                     <td><input type="text" size="20" id="usuario"value="<?php echo "$alias";?>"name="usuario"  readonly=”readonly” required ></td>
                     </tr>
                      <tr>
                     <td>Contraseña:</td>
                     <td></td>
                     <td><input type="password" size="20" id="pass"value="<?php echo "$pass";?>"name="pass"  readonly=”readonly”required ></td>
                     </tr>
                      <tr>
                     <td>Cedula:</td>
                     <td></td>
                     <td><input type="text" size="20" id="cedula"value="<?php echo "$cedula";?>"name="cedula"  readonly=”readonly” ></td>
                     </tr>
                      <tr>
                        <tr>
                        <td>rol anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$ROL"; ?> </label></td>
                       </tr>
                     <td>rol:</td>
                     <td></td>
                     ...
                     <tr>
                        <td>est anterior:</td>
                        <td></td>
                        <td><label > <?php echo"$nom"; ?> </label></td>
                       </tr>
                      <tr>
                     <td>Estado:</td>
                     <td></td>
                     <td><select id="est" name="est">
                     ...
                     <td><a href="modifiUsuario_per.php">Cancelar</a></td>
                     </tr>
