...
$link=mysql_connect("localhost","root","") or die("Erro en la Conexion");
 ...
 $que="SELECT nombre_de_proyecto FROM proyectos WHERE id_proyectos='$id';";
...
<td width="300">
<div align="left">
<img src="images/todos_somos_facatativa.jpg" ALIGN="RIGHT" alt="" width="129" height="145"/>
</div>
</td>
</tr>
</table>
<div align="center">
 <table border="0.5" align="center">
					      ...
					      <td><b>Territorio</b></td>
                            ...
                            $dompdf->render();
                            $dompdf->stream("reporte_de_alcaldia(R).pdf");
?>