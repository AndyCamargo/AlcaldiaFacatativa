...
<?php 
 ...
 ?>
<head>
<title>Mejoramiento de Vivienda</title>
...
<script type="text/javascript">
 function validarPasswd () {
  ...
  if (espacios) {
   ...
   alert("Los campos de la password deben ser  mayor a 6 caracteres");
   return false;

   }
   
    if(p1.length > 16 || p2.length >16 ){
   alert("Los campos de la password deben ser  menores a 16 caracteres");
   return false;
...
<div id="header">
	<div id="menu">
		<ul>
			<ul>
			  <ul>
			   <li><a class="" href="index.html">Inicio</a><a tabindex="-1" href="manualinicial.pdf" class="MenuBarItemSubmenu">Ayuda</a><a class="" href=".php"></a><a tabindex="-1" href=".php" class="MenuBarItemSubmenu"></a></li>
		  </ul>
		  </ul>
	      <li></li>
		  <li></li>
	...
	<div id="content">
		<div class="post">
         ...
         <!-- start -->
					...
					<div id="slider">
						<form  method="POST" onSubmit="return validarPasswd()" action="guardar_recuperado.php">
						<center>
						<h2 class="title"><span class="Estilo7">Nueva Contrase&ntildea</span></h2>
						<label>Inserte su Contrase&ntildea. Esta no debera de contener espacios en blanco y debera de coincidir en los
                          dos campos</label>
                        ...
                        <td><input type="password" name="passwd1" id="passwd1" size="20"><br /></td>
                          </tr>
                           <tr>
                        <td></td>
                        <td><label >Confirmar Contrase&ntildea:</label></td>
                        <td><input type="password" name="passwd2" id="passwd2" size="20"><br /></td>
                          </tr>
                            <tr>
                        <td>
                        </td>
	...
	<div id="sidebar">
		<ul>
				...
				<ul>
					...
					a fin de atender los requerimientos de este tipo dentro de los sectores vulnerables de la poblaci&oacuten.
					  <br> 
					  <br> 
					   Fundamentalmente fueron intervenidas las unidades con problemas estructurales, deficiencias en cocina,
					   ba&ntildeos y paredes a trav&eacutes de un proceso acompa&ntildeado por la administraci&oacuten central a trav&eacutes del Banco Agrario.
					   El SENA brindar&aacute formaci&oacuten y capacitaci&oacuten a los beneficiarios para autoconstrucci&oacuten, as&iacute mismo la administraci&oacuten 
					   de la ciudad aportar&aacute los recursos necesarios para finalizar las adecuaciones.
    </ul>
		</ul>
		<p>&nbsp;</p>
	    <p>&nbsp;</p>
