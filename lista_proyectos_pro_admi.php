...
<?php 
 ...
 $link=mysql_connect("localhost","root","") or die("Erro en la Conexion");
    ...
    $sqll="SELECT codigo,nombre_de_proyecto,ano,observaciones FROM proyectos WHERE id_proye='2';";
	$curso=mysql_query($sqll,$link) or die("Error en sql");

	$sql="SELECT codigo,nombre_de_proyecto,ano,observaciones FROM proyectos WHERE id_proye='1';";
	$ejecutado=mysql_query($sql,$link) or die("Error en sql");
 ...
 <h1>Proyectos En Curso</h1>
                       ...
                       <?php 
					      ...
					      echo "</tr>";
			          		...
			          		while($fila=mysql_fetch_array($curso)){
								echo "<tr>";
								echo "<td>".$fila[0]."</td>";
			          			echo "<td>".$fila[1]."</td>";
			          			echo "<td>".$fila[2]."</td>";
 ...
 <h1>Proyectos Ejecutados</h1>
                       ...
                       <?php 
					      ...
					      echo "</tr>";
			          		...
			          		<table>
			          		<tr>
			          		<form target="_blank" action="pdf_ejecutado.php" method="get">
			          		<td> <input type ="image" src="logos/adobe.png" ></td>
			          		</form>
			          		
                            <form  target="_blank" action="exel_ejecutados.php" method="get">
                            <td> <input type ="image" src="logos/excel.png" ></td>
                            </form>
			          		</tr>
			          		</table>
