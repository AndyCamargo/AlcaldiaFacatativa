         ...
         <!-- start -->
					...
					<div id="slider">
                      ...
                      <h1>Modificar Usuario</h1> 		
                       ...
                       <td>Cedula:</td>
                       <td></td>
                       <td><input type="text" size="20" id="cedula" value=""name="cedula" required onkeypress="return solonumeros(event)"></td>
                       <td></td>
                      ...
                      if(isset($_REQUEST['Consultar'])){
                        ...
                        $fila=mysql_fetch_row($resul);
                         ...
                         $ries=$fila[15];
                      	...
                      	?> 
                        <form action="logicaModiUsua.php" method="post">
                        ...
                        <td>Celular:</td>
                        <td></td>
                        <td><input type="text" size="20" id="celular" value="<?php echo "$celular";?>"  name="celular" onkeypress="return solonumeros(event)" required></td>
                        </tr>
                        <tr>
                        <td>N Caja:</td>
                        <td></td>
                     ...
                     <td><select id="rie" name="rie">
                      ...
                      <tr>
				        ...
				        <td><a href="modificarUsuario.php">Cancelar</a></td>
                        </tr>	
                        </table>
                      ...
                      echo "<script> alert('Usuario no exixte ');</script>";  
                    }
                    }
                    ?>
					  <div class="viewer">
